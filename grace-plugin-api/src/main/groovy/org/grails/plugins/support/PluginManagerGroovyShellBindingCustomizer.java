...
/**
 * Grails PluginManager for the {@link GroovyShellBindingCustomizer}, adding the new variable 'pluginManager'.
 *
 * @author Michael Yan
 * @since 2022.0.0
 */
public class PluginManagerGroovyShellBindingCustomizer implements GroovyShellBindingCustomizer {
    ...
    public PluginManagerGroovyShellBindingCustomizer(GrailsPluginManager pluginManager) {
        this.pluginManager = pluginManager;
    }

    @Override
    public void customize(Binding binding) {
        binding.setVariable("pluginManager", this.pluginManager);
    }
