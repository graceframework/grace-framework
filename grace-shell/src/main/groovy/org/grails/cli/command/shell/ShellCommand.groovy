 ...
 */
package org.grails.cli.command.shell
 ...
 * @since 2024.1.0
 */
class ShellCommand implements ProjectCommand {

    static final String USAGE = 'grace shell'
...
'''
    ...
    final CommandDescription description = new CommandDescription(name, 'Runs the Grace interactive shell', USAGE, EXAMPLES)
    ...
    boolean handle(ExecutionContext executionContext) {
        ...
        try {
            ...
            console.updateStatus 'Running shell...'
