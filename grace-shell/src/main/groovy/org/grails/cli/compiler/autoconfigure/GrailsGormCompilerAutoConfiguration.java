...
public class GrailsGormCompilerAutoConfiguration extends CompilerAutoConfiguration {
    ...
    public void applyDependencies(DependencyCustomizer dependencies) {
        ...
        dependencies.ifAnyMissingClasses("grails.validation.ConstrainedDelegate").add("grace-boot-validation");
        dependencies.ifAnyMissingClasses("org.grails.orm.hibernate.HibernateDatastore").add("grace-boot-hibernate");
