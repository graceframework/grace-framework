...
class PluginGenerator extends AbstractGenerator {
    ...
    boolean generate() {
        ...
        String pluginFile = 'app/plugins/' + defaultPackagePath + '/' + className + 'GrailsPlugin.groovy'
        createFile('Plugin.groovy.tpl', pluginFile, model, overwrite)
