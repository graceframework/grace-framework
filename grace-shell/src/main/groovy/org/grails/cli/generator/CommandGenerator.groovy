...
class CommandGenerator extends AbstractGenerator {
    ...
    boolean generate() {
        ...
        String commandClassFile = 'app/commands/' + defaultPackagePath + '/' + className + 'Command.groovy'
        createFile('Command.groovy.tpl', commandClassFile, model, overwrite)
