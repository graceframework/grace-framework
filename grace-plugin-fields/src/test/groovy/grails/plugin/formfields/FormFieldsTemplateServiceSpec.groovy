...
class FormFieldsTemplateServiceSpec extends BuildsAccessorFactory implements GrailsUnitTest {
    ...
    void setup() {
        ...
        personInstance = new Person(name: 'Bart Simpson', password: 'bartman', gender: Gender.Male, dateOfBirth: new Date(87, 3, 19),
                minor: true, picture: 'good looking'.bytes)
    ...
    void 'does not fail if constrained property is null'() {
        expect:
        service.getWidget(null, Object) == null
    }
