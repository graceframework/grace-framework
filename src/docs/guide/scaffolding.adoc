...
The _Fields_ plugin includes scaffolding templates you can use in the `app/views/templates/_fields` and `app/views/_fields`,

it's very easy to modify your existing scaffolding templates to use the _f:all_ tag or multiple _f:field_ tags.