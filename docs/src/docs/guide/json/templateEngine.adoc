...
This class is a regular Groovy link:{groovydoc}/template-engines.html[TemplateEngine], and you can use the engine to render JSON views outside the scope of an HTTP request.
