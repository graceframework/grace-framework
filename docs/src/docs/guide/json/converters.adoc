...
Because plugins could potentially provide converters, you can also determine the order by implementing the link:{springapidoc}/org/springframework/core/Ordered.html[Ordered] interface in your converter.
