...
class DefaultJsonViewHelper extends DefaultGrailsViewHelper {
    ...
    protected static final Set<String> TO_STRING_TYPES = [
    ...
    protected Class getGenericType(Class declaringClass, PropertyDescriptor descriptor) {
        Field field = ReflectionUtils.findField(declaringClass, descriptor.getName())
        if (field != null) {
    ...
    protected List<String> getExpandProperties(JsonView jsonView, Map arguments) {
        ...
        ResolvableGroovyTemplateEngine templateEngine = jsonView.templateEngine
        ViewConfiguration viewConfiguration = templateEngine?.viewConfiguration
