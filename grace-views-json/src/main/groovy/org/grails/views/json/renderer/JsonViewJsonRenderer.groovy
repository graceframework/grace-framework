...
class JsonViewJsonRenderer<T> extends DefaultViewRenderer<T> {
    ...
    JsonViewJsonRenderer(Class<T> targetType, SmartViewResolver viewResolver, ProxyHandler proxyHandler,
    ...
    JsonViewJsonRenderer(Class<T> targetType, MimeType mimeType, SmartViewResolver viewResolver,
