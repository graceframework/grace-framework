...
class JsonApiSpec extends Specification implements JsonViewTest, GrailsUnitTest {
    ...
    void 'test simple case'() {
        ...
        when:
        def result = render('''
import org.grails.views.json.api.Widget
...
import org.grails.views.json.api.Book
...
''', [book: returnOfTheKing])
    ...
    void 'test Relationships - multiple'() {
        ...
        when:
        JsonRenderResult result = render('''
import org.grails.views.json.api.ResearchPaper
...
''', [researchPaper: returnOfTheKing])
    ...
    void 'test errors'() {
        ...
        when:
        def result = render('''
import org.grails.views.json.api.SuperHero
...
''', [hero: mutepool])
        ...
        then:
        result.jsonText == '''{"errors":[{"code":"blank","detail":"Property [name] of class [class org.grails.views.json.api.SuperHero] cannot be blank","source":{"object":"org.grails.views.json.api.SuperHero","field":"name","rejectedValue":"","bindingError":false}}]}'''
    }
