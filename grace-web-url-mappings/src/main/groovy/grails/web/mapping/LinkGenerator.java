...
public interface LinkGenerator {
     ...
     *
     * <ul>
     *    <li>resource - If linking to a REST resource, the name of the resource or resource path to link to.
     *    Either 'resource' or 'controller' should be specified, but not both</li>
     ...
     *    <li>base -  Sets the prefix to be added to the link target address, typically an absolute server URL.
     *    This overrides the behaviour of the absolute property, if both are specified.</li>
     *    <li>absolute -  If set to "true" will prefix the link target address with the value of the grails.serverURL property from Config,
     *    or http://localhost:&lt;port&gt; if no value in Config and not running in production.</li>
     *    <li>contextPath - The context path to link to, defaults to the servlet context path</li>
