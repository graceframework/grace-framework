...
public class GrailsGormCompilerAutoConfiguration extends CompilerAutoConfiguration {
    ...
    public void applyDependencies(DependencyCustomizer dependencies) {
        dependencies.ifAnyMissingClasses("org.grails.plugins.datasource.DataSourceGrailsPlugin").add("grails-plugin-datasource");
        dependencies.ifAnyMissingClasses("org.grails.plugins.domain.DomainClassGrailsPlugin").add("grails-plugin-domain-class");
        dependencies.ifAnyMissingClasses("grails.validation.ConstrainedDelegate").add("grails-plugin-validation");
        dependencies.ifAnyMissingClasses("org.grails.orm.hibernate.HibernateDatastore").add("hibernate5");
