...
public class Grails extends SpringApplication {
    ...
    protected void configureProfiles(ConfigurableEnvironment environment, String[] args) {
        ...
        for (Map.Entry<String, Object> option : commandLine.getUndeclaredOptions().entrySet()) {
            if (option.getKey().startsWith("grails.")) {
                System.setProperty(option.getKey(), option.getValue().toString());
            }
        }
