...
public class GrailsDevToolsConfiguration {

    @Bean
    public GrailsClassPathChangedEventListener grailsClassPathChangedEventListener() {
        return new GrailsClassPathChangedEventListener();
    }
