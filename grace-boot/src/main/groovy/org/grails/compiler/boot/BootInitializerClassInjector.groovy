...
@CompileStatic
@AstTransformer
class BootInitializerClassInjector implements GrailsArtefactClassInjector {
    ...
    void performInjection(SourceUnit source, ClassNode classNode) {
        ...
        if (this.processesClassNames.contains(className)) {
            return
        }
        ...
        this.processesClassNames.add(className)
    }
