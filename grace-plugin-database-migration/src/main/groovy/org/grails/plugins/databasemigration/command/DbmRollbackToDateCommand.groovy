...
@CompileStatic
class DbmRollbackToDateCommand implements DatabaseMigrationCommand {
    ...
    void handle() {
        ...
        if (!dateStr) {
            throw new DatabaseMigrationException(
                    'Date must be specified as two strings with the format "yyyy-MM-dd HH:mm:ss" or as one strings with the format "yyyy-MM-dd"')
        }
