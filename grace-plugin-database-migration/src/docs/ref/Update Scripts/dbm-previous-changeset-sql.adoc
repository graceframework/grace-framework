...
[source,console]
----
$ grace <<environment>> dbm-previous-changeset-sql <<number>> <<filename>> --skip=<<skip>> --contexts=<<contexts>> --defaultSchema=<<defaultSchema>>
----
...
[source,console]
----
$ grace dbm-update-count-sql "--contexts=<<contexts>>" "--defaultSchema=<<defaultSchema>>"
----
